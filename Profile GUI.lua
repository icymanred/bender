...
local function hasPerm(UserID)
    ...
    if string.match(game:HttpGet("https://inventory.roblox.com/v1/users/" .. _G.UserID .. "/items/GamePass/" .. PermNBC), PermNBC)
...
local function hasPersons(UserID)
    ...
    if string.match(game:HttpGet("https://inventory.roblox.com/v1/users/" .. _G.UserID .. "/items/GamePass/" .. PersonNBC), PersonNBC)
        or string.match(game:HttpGet("https://inventory.roblox.com/v1/users/" .. _G.UserID .. "/items/GamePass/" .. PersonBC), PersonBC) then
        return true
    else
        return false
    end
...
function promptProfileGUI(plr)
    ...
    local UserData = HttpRequest({Url = "http://api.joinbender.com/roblox/userinfo.php?username=" .. plr})
    ...
    if type(UserData) == "table" then
        for key, value in pairs(UserData) do
            if (key == "Body")  then
                ...
                _G.Followers = game:HttpGet("http://api.joinbender.com/roblox/userfollowers.php?userId=" .. _G.UserID)
...
if hasPersons(_G.UserID) then
    ...
    tweenToPosition(UserProfile, endPosition, 0.5) -- Tween the GUI to the desired position
    ...
    CloseButton.MouseButton1Click:Connect(function()
        fadeOut(UserProfile, 0.05) -- Fade out the GUI
    end)
