...
task.spawn(function()
   ...
   repeat task.wait() until game:IsLoaded()
      ...
      getgenv().WhitelistCount = {} getgenv().Connections = {}  getgenv().WhitelistConnection = {} getgenv().LockedSound = false getgenv().softLagging = false;
